...
import com.project.features.chats.domain.usecases.GetSearchChatsUseCaseImpl
...
//    ): DeleteChatUseCase
    ...
    @Binds
    fun bindGetSearchChatsUseCase(
        impl: GetSearchChatsUseCaseImpl
    ): GetSearchChatsUseCase
